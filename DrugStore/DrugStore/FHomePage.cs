...
namespace DrugStore
{
    public partial class FHomePage : Form
    {
        ...
        private void btn_laphd_qlbh_Click(object sender, EventArgs e)
        {
            ...
            dataTable_banhang.Columns.Add("SODK_HD");
            dataTable_banhang.Columns.Add("TENTHUOC_HD");
            dataTable_banhang.Columns.Add("GIABAN_HD");
            dataTable_banhang.Columns.Add("SOLUONG_HD");
            dgv_cthd.DataSource = dataTable_banhang;
        }
        ...
        // START  Để ý mấy cái function sự kiện tui đánh //
        ...
        private void txtb_tienKhachDua_TextChanged(object sender, EventArgs e)
        {
            if(txt_tongTien.Text != "")
                txtb_tienTraLai.Text = (Convert.ToDouble(txt_tongTien.Text) - Convert.ToDouble(txtb_tienKhachDua.Text)).ToString();
        }
        ...
        private void dgv_bh_danhMucThuoc_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (!dsthuoc_banhang.Contains(sodk))
            {
                ...
                dataTable_banhang.Rows.Add(sodk, tenThuoc, giaban, soluongnhap);
