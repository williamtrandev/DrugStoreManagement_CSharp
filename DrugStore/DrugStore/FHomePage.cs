    ...
    public partial class FHomePage : Form
    {
        ...
        void stateLanguage(bool isVN)
        {
            if (isVN)
            {
                ...
                dgv_dshd.Columns[1].HeaderText = "Ngày xuất";
                dgv_dshd.Columns[2].HeaderText = "Số điện thoại";
            ...
            else
            {
                ...
                dgv_dshd.Columns[1].HeaderText = "Date";
                dgv_dshd.Columns[2].HeaderText = "Phone number";
